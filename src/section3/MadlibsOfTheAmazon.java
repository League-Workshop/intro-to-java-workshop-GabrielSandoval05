...
public class MadlibsOfTheAmazon {
	...
	public static void main(String[] args) {
		...
		JOptionPane.showMessageDialog(null, "If you find yourself having to cros a piranha-infested river, here's how to do it...");
		...
		String place= JOptionPane.showInputDialog("Enter a name of a place");
